...
--Command     : generate_target MIO_EMIO_wrapper.bd
--Design      : MIO_EMIO_wrapper
...
end MIO_EMIO_wrapper;

architecture STRUCTURE of MIO_EMIO_wrapper is
  component MIO_EMIO is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
