...
--Date        : Thu Oct 26 13:49:33 2017
--Host        : equipo running 64-bit major release  (build 9200)
--Command     : generate_target MIO_EMIO.bd
--Design      : MIO_EMIO
...
entity MIO_EMIO is
  ...
  attribute CORE_GENERATION_INFO of MIO_EMIO : entity is "MIO_EMIO,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=MIO_EMIO,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of MIO_EMIO : entity is "MIO_EMIO.hwdef";
end MIO_EMIO;

architecture STRUCTURE of MIO_EMIO is
  component MIO_EMIO_processing_system7_0_0 is
  port (
  ...
  end component MIO_EMIO_processing_system7_0_0;
...
begin
  GPIO_0_tri_o(0) <= processing_system7_0_GPIO_0_TRI_O(0);
  GPIO_0_tri_t(0) <= processing_system7_0_GPIO_0_TRI_T(0);
  processing_system7_0_GPIO_0_TRI_I(0) <= GPIO_0_tri_i(0);
processing_system7_0: component MIO_EMIO_processing_system7_0_0
     port map (
