...
--Command     : generate_target axi_switch_led_wrapper.bd
--Design      : axi_switch_led_wrapper
...
entity axi_switch_led_wrapper is
  port (
...
end axi_switch_led_wrapper;

architecture STRUCTURE of axi_switch_led_wrapper is
  component axi_switch_led is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
...
begin
axi_switch_led_i: component axi_switch_led
     port map (
