...
--Command     : generate_target zybo_demo2_wrapper.bd
--Design      : zybo_demo2_wrapper
...
end zybo_demo2_wrapper;

architecture STRUCTURE of zybo_demo2_wrapper is
  component zybo_demo2 is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
...
zybo_demo2_i: component zybo_demo2
     port map (
